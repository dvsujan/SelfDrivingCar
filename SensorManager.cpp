...
{
    lines.push_back({{carPos.x, carPos.y}, {carPos.x, carPos.y + 125}, BLACK});
    lines.push_back({{carPos.x, carPos.y}, {carPos.x + 100, carPos.y + 100}, BLACK});
    lines.push_back({{carPos.x, carPos.y}, {carPos.x + 125, carPos.y}, BLACK});
    lines.push_back({{carPos.x, carPos.y}, {carPos.x +100, carPos.y -100}, BLACK});
